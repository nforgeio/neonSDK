...
namespace TestModelGen.AspNet
{
    ...
    public class Test_EndToEnd : IClassFixture<AspNetFixture>
    {
        ...
        {
            var person = await client.CreateNonPersisablePersonAsync(10, "Jill", 50, Gender.Female, _cancellationToken: Xunit.TestContext.Current.CancellationToken);
        ...
        public async Task OptionalParams()
        {
            ...
            Assert.Equal(MyEnum.Three, await client.GetOptionalEnumViaQueryAsync(_cancellationToken: Xunit.TestContext.Current.CancellationToken));
            Assert.Equal(MyEnum.Two, await client.GetOptionalEnumViaQueryAsync(MyEnum.Two, _cancellationToken: Xunit.TestContext.Current.CancellationToken));
            Assert.Equal(MyEnum.Three, (await client.UnsafeGetOptionalEnumViaQueryAsync(_cancellationToken: Xunit.TestContext.Current.CancellationToken)).As<MyEnum>());
            Assert.Equal(MyEnum.Two, (await client.UnsafeGetOptionalEnumViaQueryAsync(MyEnum.Two, _cancellationToken: Xunit.TestContext.Current.CancellationToken)).As<MyEnum>());

            Assert.Equal(MyEnum.Three, await client.GetOptionalEnumViaBodyAsync(_cancellationToken: Xunit.TestContext.Current.CancellationToken));
            Assert.Equal(MyEnum.Two, await client.GetOptionalEnumViaBodyAsync(MyEnum.Two, _cancellationToken: Xunit.TestContext.Current.CancellationToken));
            Assert.Equal(MyEnum.Three, (await client.UnsafeGetOptionalEnumViaBodyAsync(_cancellationToken: Xunit.TestContext.Current.CancellationToken)).As<MyEnum>());
            Assert.Equal(MyEnum.Two, (await client.UnsafeGetOptionalEnumViaBodyAsync(MyEnum.Two, _cancellationToken: Xunit.TestContext.Current.CancellationToken)).As<MyEnum>());
        ...
        public async Task GetStringList()
        {
            ...
            Assert.Empty(await client.GetStringListAsync(new List<string>(), _cancellationToken: Xunit.TestContext.Current.CancellationToken));
        ...
        public async Task GetPersonList()
        {
            ...
            Assert.Empty(await client.GetPersonListAsync(new List<Person>(), _cancellationToken: Xunit.TestContext.Current.CancellationToken));
