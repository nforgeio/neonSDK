...
namespace Neon.Mapbox.Models
{
    public class Popup : IDisposable
    {
        ...
        public async ValueTask AddClassName(string className)
        {
            await SyncContext.Clear;

            await _Module.InvokeVoidAsync($"MapboxPopup.addClassName", ContainerId, className);
        }
        ...
        public async ValueTask AddTo(MapboxMap map)
        {
            await SyncContext.Clear;

            await _Module.InvokeVoidAsync($"MapboxPopup.addTo", ContainerId, _MapId);
        }
        ...
        public async ValueTask<LngLat> GetLngLat()
        {
            await SyncContext.Clear;

            return await _Module.InvokeAsync<LngLat>($"MapboxPopup.getLngLat", ContainerId);
        }
        ...
        public async ValueTask<string> GetMaxWidth()
        {
            await SyncContext.Clear;

            return await _Module.InvokeAsync<string>($"MapboxPopup.getMaxWidth", ContainerId);
        }

        /// <summary>
        /// </summary>
        /// <returns>true if the popup is open, false if it is closed.</returns>
        public async ValueTask<bool> IsOpen()
        {
            await SyncContext.Clear;

            return await _Module.InvokeAsync<bool>($"MapboxPopup.isOpen", ContainerId);
        }
        ...
        public async ValueTask Remove()
        {
            ...
            await _Module.InvokeVoidAsync($"MapboxPopup.remove", ContainerId);
        }
        ...
        public async ValueTask RemoveClassName(string className)
        {
            await SyncContext.Clear;

            await _Module.InvokeVoidAsync($"MapboxPopup.removeClassName", ContainerId, className);
        }
        ...
        public async ValueTask SetHtml(string html)
        {
            ...
            await _Module.InvokeVoidAsync($"MapboxPopup.setHTML", ContainerId, html);
        }
        ...
        public async ValueTask SetLngLat(LngLat lngLat)
        {
            await SyncContext.Clear;

            await _Module.InvokeVoidAsync($"MapboxPopup.setLngLat", ContainerId, lngLat);
        }
        ...
        public async ValueTask SetText(string text)
        {
            ...
            await _Module.InvokeVoidAsync($"MapboxPopup.setText", ContainerId, text);
        }
        ...
        public async ValueTask<bool> ToggleClassName(string className)
        {
            await SyncContext.Clear;

            return await _Module.InvokeAsync<bool>($"MapboxPopup.toggleClassName", ContainerId, className);
        }
