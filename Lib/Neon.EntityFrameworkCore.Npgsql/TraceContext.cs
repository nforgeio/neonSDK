...
{
    /// <summary>
    /// Holds the <see cref="ActivitySource"/> used to emit this package's OpenTelemetry tracing
    /// activities.  See <see cref="TracerProviderBuilderExtensions"/> for how consumers subscribe
    /// to it.
    /// </summary>
