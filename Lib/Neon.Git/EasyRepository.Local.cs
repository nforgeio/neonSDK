...
namespace Neon.Git
{
    public partial class EasyRepository
    {
        ...
        public async Task FetchAsync()
        {
            ...
            Commands.Fetch(Local, Origin.Name, refSpecs, options, "fetching");
        ...
        public async Task<bool> CheckoutRemoteAsync(string remoteBranchName, string branchName = null)
        {
            ...
            if (created)
            {
                Local.CreateBranch(branchName, $"{Origin.Name}/{remoteBranchName}");
            }
        ...
        public async Task RemoveBranchAsync(string branchName)
        {
            ...
            Local.Network.Push(Origin, $"+:refs/heads/{branchName}", CreatePushOptions());
