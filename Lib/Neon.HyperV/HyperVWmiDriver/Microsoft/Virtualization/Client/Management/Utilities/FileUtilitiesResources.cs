...
internal class FileUtilitiesResources
{
    ...
    internal static ResourceManager ResourceManager
    {
        get
        {
            if (resourceMan == null)
            {
                resourceMan = new ResourceManager(WmiHelper.GetResourceName("Microsoft.Virtualization.Client.Management.Utilities.FileUtilitiesResources"), typeof(FileUtilitiesResources).GetTypeInfo().Assembly);
            }
            return resourceMan;
        }
    }
