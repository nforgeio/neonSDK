...
internal sealed class VMBios : VMComponentObject, IUpdatable
{
    ...
    public BootDevice[] StartupOrder
    {
        ...
        internal set
        {
            m_VMSetting.GetData(UpdatePolicy.None).SetBootOrder(value.Select((BootDevice bootEntry) => (global::Microsoft.Virtualization.Client.Management.BootDevice)bootEntry).ToArray());
        }
    }
