...
[Cmdlet("Set", "VMSwitchExtensionPortFeature", DefaultParameterSetName = "VMName", SupportsShouldProcess = true)]
[OutputType(new Type[] { typeof(VMSwitchExtensionPortFeature) })]
internal sealed class SetVMSwitchExtensionPortFeature : VirtualizationCmdlet<VMSwitchExtensionPortFeature>, ISupportsPassthrough
{
	...
	internal override void ProcessOneOperand(VMSwitchExtensionPortFeature operand, IOperationWatcher operationWatcher)
	{
		...
		if (operationWatcher.ShouldProcess(string.Format(CultureInfo.CurrentCulture, CmdletResources.ShouldProcess_SetVMSwitchExtensionPortFeature, parentAdapter.Name)))
		{
