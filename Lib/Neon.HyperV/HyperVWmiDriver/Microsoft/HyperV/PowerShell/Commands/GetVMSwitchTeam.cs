...
internal sealed class GetVMSwitchTeam : VirtualizationCmdlet<VMSwitchTeam>
{
    ...
    internal override IList<VMSwitchTeam> EnumerateOperands(IOperationWatcher operationWatcher)
    {
        ...
        IEnumerable<VMSwitchTeam> source = ((!IsParameterSpecified("VMSwitch")) ? (from vmSwitch in global::Microsoft.HyperV.PowerShell.VMSwitch.GetSwitchesByNamesAndServers(servers, requestedSwitchNames, allowWildcards: true, ErrorDisplayMode.WriteWarning, operationWatcher)
