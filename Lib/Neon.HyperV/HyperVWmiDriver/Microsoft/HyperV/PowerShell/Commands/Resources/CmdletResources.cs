...
internal class CmdletResources
{
    ...
    internal static ResourceManager ResourceManager
    {
        get
        {
            if (resourceMan == null)
            {
                resourceMan = new ResourceManager(WmiHelper.GetResourceName("Microsoft.HyperV.PowerShell.Cmdlets.Resources.CmdletResources"), typeof(CmdletResources).GetTypeInfo().Assembly);
            }
            return resourceMan;
        }
    }
