...
[Cmdlet("Remove", "VMSwitchExtensionSwitchFeature", SupportsShouldProcess = true)]
[OutputType(new Type[] { typeof(VMSwitchExtensionSwitchFeature) })]
internal sealed class RemoveVMSwitchExtensionSwitchFeature : VirtualizationCmdlet<VMSwitchExtensionSwitchFeature>, ISupportsPassthrough
{
	...
	internal override void ProcessOneOperand(VMSwitchExtensionSwitchFeature operand, IOperationWatcher operationWatcher)
	{
		...
		if (operationWatcher.ShouldProcess(string.Format(CultureInfo.CurrentCulture, CmdletResources.ShouldProcess_RemoveVMSwitchExtensionSwitchFeature, parentSwitch.Name)))
		{
