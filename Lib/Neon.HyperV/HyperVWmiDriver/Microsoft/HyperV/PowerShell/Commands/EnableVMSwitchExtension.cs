...
[Cmdlet("Enable", "VMSwitchExtension", DefaultParameterSetName = "ExtensionName")]
[OutputType(new Type[] { typeof(VMSwitchExtension) })]
internal sealed class EnableVMSwitchExtension : VirtualizationCmdlet<VMSwitchExtension>
{
    ...
    {
        if (operationWatcher.ShouldProcess(string.Format(CultureInfo.CurrentCulture, CmdletResources.ShouldProcess_EnableVMSwitchExtension, operand.Name)))
        {
    ...
    private IEnumerable<VMSwitch> EnumerateSwitches(IOperationWatcher operationWatcher)
    {
        ...
        return global::Microsoft.HyperV.PowerShell.VMSwitch.GetSwitchesByNamesAndServers(ParameterResolvers.GetServers(this, operationWatcher), VMSwitchName, allowWildcards: true, ErrorDisplayMode.WriteWarning, operationWatcher);
    }
}
