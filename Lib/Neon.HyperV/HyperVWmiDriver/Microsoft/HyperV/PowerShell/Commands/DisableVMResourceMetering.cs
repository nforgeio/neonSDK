...
[Cmdlet("Disable", "VMResourceMetering", DefaultParameterSetName = "VMName")]
internal sealed class DisableVMResourceMetering : VirtualizationCmdlet<object>, IVMObjectOrVMNameCmdlet, IVmByObjectCmdlet, IVirtualMachineCmdlet, IServerParameters, IParameterSet, IVmByVMNameCmdlet
{
	...
	{
		MetricUtilities.ChangeMetricServiceState(MetricUtilities.MetricServiceState.Disabled, (IMeasurable)operand);
	}
}
