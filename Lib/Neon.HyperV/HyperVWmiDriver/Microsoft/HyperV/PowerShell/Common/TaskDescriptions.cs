...
internal class TaskDescriptions
{
    ...
    internal static ResourceManager ResourceManager
    {
        get
        {
            if (resourceMan == null)
            {
                resourceMan = new ResourceManager(WmiHelper.GetResourceName("Microsoft.HyperV.PowerShell.Objects.Common.TaskDescriptions"), typeof(TaskDescriptions).GetTypeInfo().Assembly);
            }
            return resourceMan;
        }
    }
