...
internal sealed class VMNetworkAdapter : VMNetworkAdapterBase, IBootableDevice
{
    ...
    public string PoolName
    {
        ...
        internal set
        {
            IEthernetConnectionAllocationRequest obj = m_ConnectionSetting.GetData(UpdatePolicy.None) as IEthernetConnectionAllocationRequest;
            string poolId = (VMResourcePool.IsPrimordialPoolName(value) ? string.Empty : value);
            obj.PoolId = poolId;
        }
    }
