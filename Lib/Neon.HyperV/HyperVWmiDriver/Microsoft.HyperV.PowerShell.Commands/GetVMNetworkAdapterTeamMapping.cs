...
[Cmdlet("Get", "VMNetworkAdapterTeamMapping", SupportsShouldProcess = false, DefaultParameterSetName = "VMName")]
[OutputType(new Type[] { typeof(VMNetworkAdapterTeamMappingSetting) })]
internal sealed class GetVMNetworkAdapterTeamMapping : VirtualizationCmdlet<VMNetworkAdapterBase>, IVmBySingularVMNameCmdlet, IVirtualMachineCmdlet, IServerParameters, IParameterSet, IVmBySingularObjectCmdlet, IVMInternalNetworkAdapterBySwitchNameCmdlet, IVMNetworkAdapterBaseCmdlet, ISupportsPassthrough
{
	...
	{
		VMNetworkAdapterTeamMappingSetting teamMappingSetting = operand.TeamMappingSetting;
		if (teamMappingSetting != null)
		{
			operationWatcher.WriteObject(teamMappingSetting);
		}
	}
}
