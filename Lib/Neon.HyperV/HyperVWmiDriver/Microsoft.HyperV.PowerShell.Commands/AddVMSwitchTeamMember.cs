...
internal sealed class AddVMSwitchTeamMember : VirtualizationCmdlet<VMSwitch>, ISupportsPassthrough
{
	...
	{
		IList<VMSwitch> list = ((!IsParameterSpecified("VMSwitch")) ? Microsoft.HyperV.PowerShell.VMSwitch.GetSwitchesByNamesAndServers(ParameterResolvers.GetServers(this, operationWatcher), VMSwitchName, allowWildcards: true, ErrorDisplayMode.WriteError, operationWatcher) : VMSwitch);
