...
[Cmdlet("Add", "VMStoragePath", SupportsShouldProcess = true)]
[OutputType(new Type[] { typeof(VMStorageResourcePool) })]
internal sealed class AddVMStoragePath : VirtualizationCmdlet<VMStorageResourcePool>, ISupportsPassthrough
{
	...
	internal override void ProcessOneOperand(VMStorageResourcePool operand, IOperationWatcher operationWatcher)
	{
		...
		{
			operand.AddStoragePaths(Path, operationWatcher);
