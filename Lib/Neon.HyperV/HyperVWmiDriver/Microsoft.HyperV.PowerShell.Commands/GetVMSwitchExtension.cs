...
internal sealed class GetVMSwitchExtension : VirtualizationCmdlet<VMSwitchExtension>
{
	...
	{
		IEnumerable<VMSwitch> inputs = ((!CurrentParameterSetIs("SwitchName")) ? VMSwitch : Microsoft.HyperV.PowerShell.VMSwitch.GetSwitchesByNamesAndServers(ParameterResolvers.GetServers(this, operationWatcher), VMSwitchName, allowWildcards: true, ErrorDisplayMode.WriteWarning, operationWatcher));
