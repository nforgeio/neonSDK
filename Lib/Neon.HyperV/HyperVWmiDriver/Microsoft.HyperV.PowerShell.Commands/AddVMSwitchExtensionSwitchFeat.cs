...
internal sealed class AddVMSwitchExtensionSwitchFeature : VirtualizationCmdlet<VMSwitch>, ISupportsPassthrough
{
	...
	internal override IList<VMSwitch> EnumerateOperands(IOperationWatcher operationWatcher)
	{
		...
		{
			return Microsoft.HyperV.PowerShell.VMSwitch.GetSwitchesByNamesAndServers(ParameterResolvers.GetServers(this, operationWatcher), SwitchName, allowWildcards: true, ErrorDisplayMode.WriteWarning, operationWatcher);
		}
		return VMSwitch;
	}
