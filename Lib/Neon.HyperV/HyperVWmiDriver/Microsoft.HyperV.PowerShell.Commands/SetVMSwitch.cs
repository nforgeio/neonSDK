...
internal sealed class SetVMSwitch : VirtualizationCmdlet<VMSwitch>, ISupportsPassthrough
{
	...
	internal override IList<VMSwitch> EnumerateOperands(IOperationWatcher operationWatcher)
	{
		...
		return Microsoft.HyperV.PowerShell.VMSwitch.GetSwitchesByNamesAndServers(ParameterResolvers.GetServers(this, operationWatcher), Name, allowWildcards: true, ErrorDisplayMode.WriteError, operationWatcher);
	}
