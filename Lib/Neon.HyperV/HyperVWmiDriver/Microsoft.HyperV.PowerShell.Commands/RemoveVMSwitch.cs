...
internal sealed class RemoveVMSwitch : VirtualizationCmdlet<object>, ISupportsForce
{
	...
	internal override IList<object> EnumerateOperands(IOperationWatcher operationWatcher)
	{
		...
		IEnumerable<VMSwitch> source = ((!CurrentParameterSetIs("Name")) ? VMSwitch : Microsoft.HyperV.PowerShell.VMSwitch.GetSwitchesByNamesAndServers(ParameterResolvers.GetServers(this, operationWatcher), Name, allowWildcards: true, ErrorDisplayMode.WriteError, operationWatcher));
