...
internal sealed class RenameVMGroup : VirtualizationCmdlet<VMGroup>, ISupportsPassthrough
{
	...
	internal override IList<VMGroup> EnumerateOperands(IOperationWatcher operationWatcher)
	{
		...
		{
			return Microsoft.HyperV.PowerShell.VMGroup.GetVMGroupsByName(servers, Name, operationWatcher);
		}
		return Microsoft.HyperV.PowerShell.VMGroup.GetVMGroupsById(servers, Id, operationWatcher);
	}
