...
namespace Neon.Diagnostics
{
    ...
    public static class ConfigExtensions
    {
        ...
        /// <param name="configure">Exporter configuration options.</param>
        /// <returns>The <paramref name="loggerOptions"/> to enable fluent style programming.</returns>
        public static OpenTelemetryLoggerOptions AddLogAsTraceProcessor(this OpenTelemetryLoggerOptions loggerOptions, Action<LogAsTraceProviderOptions> configure = null)
        {
            Covenant.Requires<ArgumentNullException>(loggerOptions != null, nameof(loggerOptions));

            var options = new LogAsTraceProviderOptions();
