...
namespace Neon.Deployment
{
    ...
    public interface IProfileClient
    {
        ...
        string GetSecretPassword(string name, string vault = null, bool nullOnNotFound = false);
        ...
        /// <returns>The password value.</returns>
        /// <exception cref="ProfileException">Thrown if the profile server returns an error.</exception>
        string GetSecretValue(string name, string vault = null, bool nullOnNotFound = false);
