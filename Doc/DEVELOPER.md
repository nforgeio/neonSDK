...
15. Install some SDKs:
   ...
   * Install **.NET 6.0 SDK 6.0.400** from [here](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/sdk-6.0.400-windows-x64-installer) (.NET SDK x64 installer)
   * Install **.NET 6.0 SDK 6.0.400** from [here](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/sdk-6.0.400-windows-x86-installer) (.NET SDK x68 installer) **NOTE:** It seems like the **x86** version is required to run unit tests
